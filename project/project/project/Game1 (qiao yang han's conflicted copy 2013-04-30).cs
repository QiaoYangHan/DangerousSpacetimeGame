...
namespace project
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            else if (gamestate == GameStates.RunningPlayer)
            {
                if (input.Comma)
                {
                    ...
                    {
                        player.setShip();
                        player.position = player.oldPostion - new Vector2(-100, 50);
                    }
                    if (player.playerRectangle.Intersects(ship.teleportConsole.consoleRec))
                    {
                        foreach (Planet p in ps)
                        {
                            ...
                            {
                                player.oldPostion = player.position;
        ...
        private void GameSetUp()
        {
            ...
            ecs.Clear();
            ets.Clear();
            ees.Add(new EnemyEvader(Content, new Vector2(1900, 950), -1800, -400));
            ees.Add(new EnemyEvader(Content, new Vector2(1900, 950), -1700, 100));
            ees.Add(new EnemyEvader(Content, new Vector2(1900, 950), -1800, -50));
            ees.Add(new EnemyEvader(Content, new Vector2(1900, 950), -1650, 280));
            ees.Add(new EnemyEvader(Content, new Vector2(1900, 950), -1450, 500));
            ees.Add(new EnemyEvader(Content, new Vector2(1900, 950), -1820, 450));
            ees.Add(new EnemyEvader(Content, new Vector2(1900, 950), 3600, 1800));
            ees.Add(new EnemyEvader(Content, new Vector2(1900, 950), 3000, 1800));
            ees.Add(new EnemyEvader(Content, new Vector2(1900, 950), 3600, 1500));
